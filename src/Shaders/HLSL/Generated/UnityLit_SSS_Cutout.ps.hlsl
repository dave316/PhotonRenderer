...
void surf(Input i, inout SurfaceOutputStandardSpecular o)
{
    ...
    mainLightDataIn6.dummy = 0.0;
	MainLightDataOut mainLightDataOut6;
    mainLightDataOut6.Light_Direction = float3(0, 0, 0);
    mainLightDataOut6.Light_Colour = float3(0, 0, 0);
    mainLightDataOut6.Distance_Attenuation = 0;
    mainLightDataOut6.Shadow_Attenuation = 0;
