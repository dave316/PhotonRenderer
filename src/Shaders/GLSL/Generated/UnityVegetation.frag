...
#define _Wind_Frequency material._Wind_Frequency
#define _Wind_Ondulation material._Wind_Ondulation
#define _Wind_Power material._Wind_Power
#define _Normal_Power material._Normal_Power
#define _Specular material._Specular
...
void vertexDataFunc( inout appdata_full v, out Input o )
{
	...
	vec3 ase_vertex3Pos = v.vertex.xyz;
...
void surf( Input i , inout SurfaceOutputStandardSpecular o )
{
	...
	vec4 tex2DNode6 = tex2D( _Albedo, uv_Albedo );
	o.Albedo = ( _Color * tex2DNode6 ).rgb;
	vec3 temp_cast_1 = (_Specular).xxx;
