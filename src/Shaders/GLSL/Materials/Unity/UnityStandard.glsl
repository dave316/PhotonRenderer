...
void surf(Input i, inout SurfaceOutputStandardSpecular o)
{
	...
	vec2 var9 = vec2(_DetailAlbedoMap_ST.r, _DetailAlbedoMap_ST.g);
	vec2 var10 = vec2(_DetailAlbedoMap_ST.b, _DetailAlbedoMap_ST.a);
	vec4 var11 = var4 * _Color;
	float var12 = mix(1.0, var6.g, _OcclusionStrength);
	vec4 var13 = _SPECGLOSSMAP ? var7 : _SpecColor;
	float var14 = _SPECGLOSSMAP ? var7.a : _Glossiness;
	vec2 var15 = i.uv_texcoord * var9 + var10;
	o.Occlusion = var12;
	o.Specular = vec3(var13);
	o.Smoothness = var14;
	vec4 var19 = tex2D(_DetailAlbedoMap, var15);
	vec4 var20 = UnpackNormal4(_DetailNormalMap, var15);
	vec4 var21 = var19 * var1;
	vec3 var22 = ScaleNormal(vec3(var20), _DetailNormalMapScale);
	vec4 var23 = mix(vec4(1.0, 1.0, 1.0, 1.0), var21, vec4(var8.a));
	vec3 var24 = BlendNormals(var22, vec3(var5));
	vec4 var25 = var23 * var11;
	vec3 var26 = mix(vec3(var5), var24, vec3(var8.a));
	o.Albedo = vec3(var25);
	o.Normal = var26;
}
