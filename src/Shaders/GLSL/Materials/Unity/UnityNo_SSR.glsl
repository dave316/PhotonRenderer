...
void surf( Input i , inout SurfaceOutputStandard o )
{
	...
	vec4 tex2DNode4 = tex2D( _Metallic, uv_Metallic );
	...
	float mixResult9 = mix( 1 , tex2D( _AmbientOcclusion, uv_AmbientOcclusion ).g , _AmbientOcclusion_Power);
	o.Occlusion = mixResult9;
	o.Alpha = 1;
}
