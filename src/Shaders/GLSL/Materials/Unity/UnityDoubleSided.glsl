...
#define _AmbientOcclusion_ST material._AmbientOcclusion_ST
#define _Normal_Power material._Normal_Power
#define _Smoothness material._Smoothness
#define _AmbientOcclusion_Power material._AmbientOcclusion_Power
#define _Cutoff material._Cutoff
#define _Normal material._Normal
#define _Albedo material._Albedo
#define _Metallic material._Metallic
#define _AmbientOcclusion material._AmbientOcclusion
...
void surf( Input i , inout SurfaceOutputStandard o )
{
	...
	vec4 tex2DNode1 = tex2D( _Albedo, uv_Albedo );
	o.Albedo = ( _Color * tex2DNode1 ).rgb;
	vec2 uv_Metallic = i.uv_texcoord * _Metallic_ST.xy + _Metallic_ST.zw;
	vec4 tex2DNode3 = tex2D( _Metallic, uv_Metallic );
	o.Metallic = tex2DNode3.r;
	o.Smoothness = ( tex2DNode3.a * _Smoothness );
	vec2 uv_AmbientOcclusion = i.uv_texcoord * _AmbientOcclusion_ST.xy + _AmbientOcclusion_ST.zw;
	vec4 temp_cast_1 = (tex2D( _AmbientOcclusion, uv_AmbientOcclusion ).g).xxxx;
	vec4 mixResult8 = mix( vec4(1,1,1,0) , temp_cast_1 , _AmbientOcclusion_Power);
	o.Occlusion = mixResult8.r;
	o.Alpha = 1;
